...
const port = process.env.PORT || 18088 // must be the same to client.js signalingServerPort
...
const view = {
  ...
  user: path.join(__dirname, '../../', 'public/view/user.html'),
...
// Join Room from users
app.get('/user', (req, res) => {
  res.sendFile(view.user)
})
